...
describe('Cart', () => {
    ...
    describe('getTotal()', () => {
        ...
        it('should multiply quantitu and price and receive the total amount', () => {
            const item = {
                product,
                quantity: 2
            }
        ...
        it('should ensure no more than exists at a time', () => {
            cart.add({
                product,
                quantity: 2
            });
        ...
        it('should update total whe na product gets includes and then removed', () => {
            cart.add({
                product,
                quantity: 2
            });
    ...
    describe('special conditions', () => {
        ...
        it('should NOT apply quantity discount for even quantities when condition is not', () => {
            const condition = {
                quantity: 2,
            }
